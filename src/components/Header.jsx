    ...
    <div className="position-relative" ref={dropdownRef}>
      <button
        ...
        style={{ 
          border: 'none', 
          background: 'none',
          color: theme === 'light' ? '#000' : '#fff' // Dynamic color
        }}
      >
        ...
        <span className={`theme-text text-capitalize d-none d-md-block me-1`} style={{ color: theme === 'light' ? '#000' : '#fff' }}>
          {theme}
        </span>
        <FaChevronDown 
          ...
          <div className="p-3">
            <div className="d-flex align-items-center mb-3">
              ...
              <h6 className={`mb-0 fw-bold small text-uppercase ${
                theme === 'light' ? 'text-muted' : 'text-light'
              }`}>
                Theme Style
              </h6>
            </div>
                ...
                <div key={option} className="col-6">
                  <button
                    className={`btn btn-sm w-100 d-flex align-items-center justify-content-start ${
                      ...
                      (theme === 'light' ? "btn-outline-secondary" : "btn-outline-light")
                    }`}
                    onClick={() => {
                      setTheme(option);
                      setIsOpen(false);
...
// Helper function cho preview màu (chỉ light/dark)
...
const Header = ({ onSidebarToggle }) => {
  ...
  const headerBackgroundStyle = theme === 'light' 
    ? {
  ...
  const buttonHoverBg = theme === 'light' ? 'rgba(0, 0, 0, 0.1)' : 'rgba(255, 255, 255, 0.1)';
      ...
      <div className="header-content container-fluid">
        <div className="header-left d-flex align-items-center">
          ...
          <button
            ...
            onMouseOver={(e) => (e.currentTarget.style.background = navIconHoverBg)}
            onMouseOut={(e) => (e.currentTarget.style.background = navIconBg)}
          >
            <FaBars />
          </button>
          ...
          <div className={`search-container ${searchFocused ? 'focused' : ''}`}>
            ...
            {searchFocused && (
              <div className={`search-dropdown position-absolute rounded shadow-lg border mt-1 ${
                theme === 'light' ? 'bg-white' : 'bg-dark'
              }`}>
                <div className="search-section p-3">
                  <h6 className={`search-section-title ${theme === 'light' ? 'text-muted' : 'text-light'}`}>
                    Recent Searches
                  </h6>
